function trustLevel(targetID)

sTargetID = sprintf('%02u', targetID);

a = dlmread(['Output/Out-Trust-A' sTargetID '.txt'], '\t');
aLength = size(a);
aLength = aLength(:,1);
...
for i = 1:idsSize
    ...
    set(gca, 'YTickLabel', {'C_U', 'U', 'N', 'P_T', 'T'});
...
print('-deps2', ['Output/Out-Trust-A' sTargetID '-FirstSimulationStep.eps']);
...
print('-deps2', ['Output/Out-Trust-A' sTargetID '.eps']);
